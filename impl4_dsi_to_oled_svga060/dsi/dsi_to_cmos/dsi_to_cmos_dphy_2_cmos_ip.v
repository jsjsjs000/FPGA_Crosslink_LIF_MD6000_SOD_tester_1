...
// Filename: dsi_to_cmos_dphy_2_cmos_ip.v   IP package: D-PHY to CMOS 1.3
// Copyright(c) 2016 Lattice Semiconductor Corporation. All rights reserved. 
//===========================================================================

module dsi_to_cmos_dphy_2_cmos_ip #(
    parameter RX_TYPE      = "DSI",        // "DSI" or "CSI2" 
    parameter TX_TYPE      = "CMOS",       // "DSI", "CSI2", "CMOS" or "LVDS"
    parameter NUM_RX_LANE  = 4,            // 1, 2, 3 or 4
    parameter RX_GEAR      = 8,           // 8 or 16
    ...
    parameter RX_CLK_MODE  = "HS_ONLY",      // "HS_LP" or "HS_ONLY"
    parameter TX_WAIT_TIME = "LESS_15MS",  // "OVER_15MS" or "LESS_15MS"
    parameter BYTECLK_MHZ  = 30.0000,          // Target byte clock frequency
    parameter LANE_ALIGN   = "ON",        // Added to integrate word_aligner+lane_aligner in hard-dphy
    parameter WORD_ALIGN   = "ON",        // Added to integrate word_aligner+lane_aligner in hard-dphy
